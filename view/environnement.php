    ...
    <div class="env_defunct">
        ...
        <div  class="photos_list hidden">
            <?php if($defunct_photos) :?>
                ...
                <div class="min_photo">
                    <img class="img" src="public/pictures/photos/<?=$r['user_id'].'/'.$r['name'] ?>" alt="photos de defunt">
            ...
            <?php else :?>
                <div class="min_nophoto">
                    <p><i class="fas fa-ban"></i>&nbsp;Aucune photo associé à <?=ucfirst($defunct_infos['firstname']).' '.ucfirst($defunct_infos['lastname']) ?>&nbsp;<i class="fas fa-ban"></i></p>
                </div> 
            <?php endif ?>
        </div>
        <hr>
