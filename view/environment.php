...
// Dossier de téléchargement des photos du defunt sélectionné
           if (isset($_SESSION['user']['id'])) :?>
        <a class="env__folder_link" href="" title="Dossier de stockage des photos">
            <div class="env__folder">
...
// Affichage des photos 
              if (!isset($_SESSION['user']['id'])) :?>
                <img class="img env__blur_photo" src="public/pictures/photos/<?=$r['user_id'].'/'.$r['name']?>" alt="<?=$r['name']?>">
            <?php else :?>
                <img class="img" src="public/pictures/photos/<?=$r['user_id'].'/'.$r['name']?>" alt="<?=$r['name']?>">
        <?php endif ?>
            </div>
            <div class="env__comment">
        <?php 
